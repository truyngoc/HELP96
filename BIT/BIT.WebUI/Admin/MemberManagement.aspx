                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Wallet" ItemStyle-HorizontalAlign="Left">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lblWallet" runat="server" OnClick="lnkBlockchain_Click" CommandName="lnkWallet" CommandArgument='<%# Eval("Wallet") %>' Text='<%#Eval("Wallet").ToString() %>' Font-Bold="true" ForeColor="#2d3fda"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
